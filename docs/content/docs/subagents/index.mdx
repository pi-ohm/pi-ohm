...
```json title=".pi/ohm.json" tab="Custom agents"
{
  ...
  "subagents": {
    "my-agent": {
      ...
      "description": "Use for specialized project work that needs my custom instructions.",
    ...
    "my-agent": {
      ...
      "variants": {
        "*gemini*": {
          ...
          "description": "Use this variant for Gemini-specific research and synthesis.",
          "permissions": {
            "bash": "deny",
            "edit": "deny",
            "apply_patch": "deny"
        ...
        "*claude*": {
          ...
          "description": "Use this variant for Claude-specific review and planning.",
          "permissions": {
            "bash": "deny"
          }
        }
