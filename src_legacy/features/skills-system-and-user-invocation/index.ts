...
export const skills_system_and_user_invocationFeature: FeatureDefinition = {
  ...
  dependsOn: [],
  sourceUrls: ["https://ampcode.com/manual", "https://ampcode.com/news/agent-skills", "https://ampcode.com/news/user-invokable-skills", "https://ampcode.com/news/slashing-custom-commands"],
};
